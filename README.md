...
Para forzar visibilidad de cambios en BCApi, ahora existe un endpoint raíz que expone versión y esquema activo:
...
```json
{
  ...
  "status": "online",
  "api_version": "2.1.0",
  "schema": "NanoEncuestaBC-v1",
  "message": "Cambios activos en BCApi para #LaEncuestaBC"
}
```
